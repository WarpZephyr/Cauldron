...
public class CFG
{
    ...
    /// <summary>
    /// The local build folder for Cauldron (used for some tools)
    /// </summary>
    public string CauldronBuildFolder = "";
    ...
    /// <summary>
    /// The relative path (from the Cauldron.exe) to the font used for English text.
    /// </summary>
    public string System_English_Font = Path.Join("Assets","Fonts","RobotoMono-Light.ttf");

    /// <summary>
    /// The relative path (from the Cauldron.exe) to the font used for non-English text.
    /// </summary>
...
#pragma warning restore IDE0051
    ...
    public static void Load()
    {
        ...
        else
        {
            ...
            {
                TaskLogs.AddLog("[Cauldron] Configuration failed to load, default configuration has been restored.", LogLevel.Error, LogPriority.High, e);

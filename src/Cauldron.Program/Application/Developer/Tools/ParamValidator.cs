...
public static class ParamValidator
{
    ...
    public static void ValidatePadding(Cauldron baseEditor, ProjectEntry project, bool allParams = false)
    {
        if (allParams)
        {
    ...
    public static void ValidatePaddingForParam(Cauldron baseEditor, ProjectEntry project, string selectedParamName)
    {
    ...
    public static void ValidateParamdef(Cauldron baseEditor, ProjectEntry curProject)
    {

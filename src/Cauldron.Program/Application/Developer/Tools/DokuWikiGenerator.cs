...
public static class DokuWikiGenerator
{
    ...
    public static void OutputParamTableInformation(Cauldron baseEditor, ProjectEntry curProject)
    {
    ...
    public static void OutputParamInformation(Cauldron baseEditor, ProjectEntry project, string paramKey)
    {
        var editor = baseEditor.ProjectManager.SelectedProject.ParamEditor;

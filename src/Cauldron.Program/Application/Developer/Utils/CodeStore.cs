...
public static void GenerateTableGroupNames(Cauldron baseEditor, ProjectEntry curProject)
{
    ...
    var dir = Path.Combine(CFG.Current.CauldronBuildFolder,
        "src", "Cauldron.Data", "Assets", "PARAM",
...
public void GenerateUpgraderInfo(Cauldron baseEditor, ProjectEntry curProject)
{
    var srcPath = Path.Combine(CFG.Current.CauldronBuildFolder,
        "src", "Cauldron.Data", "Assets", "PARAM",
    ...
    try
    {
        ...
        try
        {
            ...
            UpgraderInfo = JsonSerializer.Deserialize(filestring, CauldronSerializerContext.Default.ParamUpgraderInfo);
        }
        catch (Exception e)
        {
...
{
    var outputDir = $@"{CFG.Current.CauldronBuildFolder}\src\Cauldron.Data\Assets\PARAM\BB\Icon Layouts";
...
{
    var outputDir = $@"{CFG.Current.CauldronBuildFolder}\_temp";
    ...
    try
    {
        ...
        store = JsonSerializer.Deserialize(filestring, CauldronSerializerContext.Default.RowNameStore);
...
public static void SplitAliases()
{
    ...
    string aliasesDir = @$"G:\Creative\GitHub\Cauldron\src\Cauldron.Data\Assets\Aliases";
    ...
    foreach (string gameDir in games)
    {
        ...
        AliasStore store = JsonSerializer.Deserialize(sourceFile, CauldronSerializerContext.Default.AliasStore);

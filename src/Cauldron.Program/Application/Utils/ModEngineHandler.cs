...
public static class ModEngineHandler
{
    ...
    public static void LaunchME3Mod(ProjectEntry curProject)
    {
        ...
        {
            TaskLogs.AddLog($"[Cauldron] Failed to find profile: {readPath}");
        }
    }
    ...
    public static void LaunchME2Mod(ProjectEntry curProject)
    {
        ...
        var modTomlPath = @$"{modEngineInstallFolderPath}\cauldron_launch_config.toml";
...
enabled = false";
        ...
        {
            var tomlPath = Path.Combine(modEngineInstallFolderPath, "cauldron_launch_config.toml");

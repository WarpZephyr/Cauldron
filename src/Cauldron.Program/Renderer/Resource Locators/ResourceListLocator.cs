...
public static class ResourceListLocator
{
    ...
    public static List<string> GetChrModels(ProjectEntry project)
    {
        ...
        {
            TaskLogs.AddLog($"[Cauldron] Failed to find characer models.", LogLevel.Error, LogPriority.High, e);
    ...
    public static List<string> GetPartsModels(ProjectEntry project)
    {
        ...
        {
            TaskLogs.AddLog($"[Cauldron] Failed to find part models.", LogLevel.Error, LogPriority.High, e);

                ...
                if (Editor.Project.ParamData.PrimaryBank.Params != null)
                {
                    ...
                    switch (CurrentTargetCategory)
                    {
                        case ParamOperationTargetType.SelectedRows:
                            ...
                            PlatformUtils.Instance.MessageBox($"Row names for {rows.Count} selected rows have been trimmed.", $"Cauldron", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            break;
                        case ParamOperationTargetType.SelectedParam:
                            TrimRowNameHelper(activeParam);
                            PlatformUtils.Instance.MessageBox($"Row names for {activeParam} have been trimmed.", $"Cauldron", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            break;
                        case ParamOperationTargetType.AllParams:
                            ...
                            PlatformUtils.Instance.MessageBox($"Row names for all params have been trimmed.", $"Cauldron", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            break;
                        default:

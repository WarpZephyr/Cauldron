...
public class PinGroups
{
    ...
    {
        ParamGroupPath = Path.Join(Editor.Project.ProjectPath, ".cauldron", "Workflow", "Pin Groups", "Params");
        RowGroupPath = Path.Join(Editor.Project.ProjectPath, ".cauldron", "Workflow", "Pin Groups", "Rows");
        FieldGroupPath = Path.Join(Editor.Project.ProjectPath, ".cauldron", "Workflow", "Pin Groups", "Fields");
    }

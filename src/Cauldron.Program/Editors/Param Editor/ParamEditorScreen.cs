...
public class ParamEditorScreen : EditorScreen
{
    ...
    public ParamEditorScreen(Cauldron baseEditor, ProjectEntry project)
    {
    ...
    public void StatisticPopups()
    {
        if (ImGui.BeginPopup("distributionPopup"))
        {
            ...
            catch (Exception e)
            {
                ...
                TaskLogs.AddLog($"[Cauldron:Param Editor] StatisticPopups buttons failed.", LogLevel.Error, LogPriority.High, e);
            }
    ...
    private static void TryWriteFile(string path, string text)
    {
        ...
        {
            TaskLogs.AddLog($"[Cauldron:Param Editor] Failed to write file: {path}.", LogLevel.Error, LogPriority.High, e);
    ...
    private static string TryReadFile(string path)
    {
        ...
        {
            TaskLogs.AddLog($"[Cauldron:Param Editor] Failed to read file: {path}.", LogLevel.Error, LogPriority.High, e);

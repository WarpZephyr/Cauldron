...
public class MassEditHandler
{
    ...
    public void DisplayMassEditScriptMenu()
    {
        ...
        if (ImGui.CollapsingHeader("Mass Edit - Scripts"))
        {
            ...
            {
                var projectScriptDir = Path.Join(Editor.Project.ProjectPath, ".cauldron", "Assets", "Scripts");
    ...
    public void SaveMassEditScript()
    {
        if (NewScriptName == "")
        {
            PlatformUtils.Instance.MessageBox($"Name must not be empty.", "Cauldron", MessageBoxButtons.OK);
            return;
        }

        var scriptPath = Path.Combine(Editor.Project.ProjectPath, ".cauldron", "Assets", "Scripts", $"{NewScriptName}.txt");
        ...
        {
            PlatformUtils.Instance.MessageBox($"{NewScriptName}.txt already exists within the Scripts folder.", "Cauldron", MessageBoxButtons.OK);
        }

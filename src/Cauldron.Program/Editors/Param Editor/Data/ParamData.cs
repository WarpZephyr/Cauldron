...
public class ParamData
{
    ...
    public ParamData(Cauldron baseEditor, ProjectEntry project)
    {
    ...
    public async Task<bool> SetupParamMeta()
    {
        ...
        var projectMetaDir = Path.Join(Project.ProjectPath, ".cauldron", "Assets", "PARAM", ProjectUtils.GetGameDirectory(Project), "Meta");
    ...
    public async Task<bool> SetupGraphLegends()
    {
        ...
        if(CFG.Current.Param_UseProjectMeta)
        {
            var projFolder = Path.Combine(Project.ProjectPath, ".cauldron", "Project");
    ...
    public async Task<bool> SetupTableGroupNames()
    {
        ...
        // Project Store
        var projDir = Path.Combine(Project.ProjectPath, ".cauldron", "Project", "Community Table Names");
    ...
    public async Task<bool> SetupTableParamList()
    {
        ...
        var projFile = Path.Combine(Project.ProjectPath, ".cauldron", "Project", "Table Params.json");
    ...
    public void CreateProjectMetadata()
    {
        ...
        var projectDir = Path.Join(Project.ProjectPath, ".cauldron", metaDir);
    ...
    public void CopyMetadataFile(string name)
    {
        ...
        var targetFolder = Path.Combine(Project.ProjectPath, ".cauldron", "Project");
    ...
    public async Task<bool> SetupParamMemoryOffsets()
    {
        ...
        if (File.Exists(targetFile))
        {
            try
            {
                ...
                {
                    TaskLogs.AddLog($"[Cauldron] Failed to deserialize the Param Reload offsets: {targetFile}", LogLevel.Error, LogPriority.High, e);
                }
            }
            catch (Exception e)
            {
                TaskLogs.AddLog($"[Cauldron] Failed to read the Param Reload offsets: {targetFile}", LogLevel.Error, LogPriority.High, e);
            }
        }
    ...
    public async Task<bool> SetupParamCategories()
    {
        ...
        var projectFolder = Path.Join(Project.ProjectPath, ".cauldron", "Assets", "PARAM", ProjectUtils.GetGameDirectory(Project.ProjectType));
        ...
        if (File.Exists(targetFile))
        {
            try
            {
                ...
                {
                    TaskLogs.AddLog($"[Cauldron] Failed to deserialize the Param Categories: {targetFile}", LogLevel.Error, LogPriority.High, e);
                }
            }
            catch (Exception e)
            {
                TaskLogs.AddLog($"[Cauldron] Failed to read the Param Categories: {targetFile}", LogLevel.Error, LogPriority.High, e);
            }
        }
    ...
    public async Task<bool> SetupCommutativeParamGroups()
    {
        ...
        if (File.Exists(targetFile))
        {
            try
            {
                ...
                {
                    TaskLogs.AddLog($"[Cauldron] Failed to deserialize the Commutative Param Groups: {targetFile}", LogLevel.Error, LogPriority.High, e);
                }
            }
            catch (Exception e)
            {
                TaskLogs.AddLog($"[Cauldron] Failed to read the Commutative Param Groups: {targetFile}", LogLevel.Error, LogPriority.High, e);
            }
        }

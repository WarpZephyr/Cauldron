...
public class MapBank
{
    ...
    public MapBank(string name, Cauldron baseEditor, ProjectEntry project, VirtualFileSystem targetFs)
    {
...
public class MapWrapper
{
    ...
    public MapWrapper(Cauldron baseEditor, ProjectEntry project, FileDictionaryEntry dictEntry, VirtualFileSystem targetFS)
    {
        BaseEditor = baseEditor;
        Project = project;
        TargetFS = targetFS;

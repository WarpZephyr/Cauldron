...
public class DisplayGroupTool
{
    ...
    {
        DrawGroup dg = Editor.MapViewportView.RenderScene.DisplayGroup;
    ...
    public void DisplayFooterSection(DrawGroup dg, uint[] sdrawgroups, uint[] sdispgroups, HashSet<Entity> sels)
    {
        ...
        if (DisplayHelpText)
        {
            ...
            UIHelper.WrappedText(
                ...
                "Also, CollisionName references will be targeted by Cauldron when using `Set Selection`/`Get Selection` instead of your actual selection.\n" +

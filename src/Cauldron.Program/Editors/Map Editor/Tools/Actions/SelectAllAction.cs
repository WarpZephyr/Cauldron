...
public class SelectAllAction
{
    ...
    public void SelectAllByModelName()
    {
        if (Editor.ViewportSelection.IsSelection())
        {
            ...
            {
                PlatformUtils.Instance.MessageBox("Failed to select map container.", "Cauldron", MessageBoxButtons.OK);
                return;
            }
        ...
        {
            PlatformUtils.Instance.MessageBox("No object selected.", "Cauldron", MessageBoxButtons.OK);
        }
    }

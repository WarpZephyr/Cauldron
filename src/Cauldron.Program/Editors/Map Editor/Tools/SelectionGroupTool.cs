...
public class SelectionGroupTool
{
    ...
    private void DeleteSelectionGroup()
    {
        ...
        {
            result = PlatformUtils.Instance.MessageBox($"You are about to delete this selection group. Are you sure?", $"Cauldron", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        }

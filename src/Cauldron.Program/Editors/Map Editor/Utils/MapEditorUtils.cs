...
public class MapEditorUtils
{
    ...
    public static void UpdateAllEntityModels(Cauldron baseEditor, ProjectEntry projectEntry)
    {
    ...
    /// <param name="projectEntry"></param>
    /// <returns></returns>
    public static List<Entity> GetAllEntities(Cauldron baseEditor, ProjectEntry projectEntry)
    {
    ...
    /// <param name="projectEntry"></param>
    /// <returns></returns>
    public static List<Entity> GetCurrentMapEntities(Cauldron baseEditor, ProjectEntry projectEntry)
    {
        var entities = new List<Entity>();

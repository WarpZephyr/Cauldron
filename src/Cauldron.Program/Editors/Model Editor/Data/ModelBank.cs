...
public class ModelBank
{
    ...
    public ModelBank(string name, Cauldron baseEditor, ProjectEntry project, VirtualFileSystem targetFs)
    {
...
public class ModelContainerWrapper
{
    ...
    public ModelContainerWrapper(Cauldron baseEditor, ProjectEntry project, FileDictionaryEntry dictEntry, VirtualFileSystem targetFS)
    {
        BaseEditor = baseEditor;
        Project = project;
        TargetFS = targetFS;
    ...
    public void PopulateModelList()
    {
        ...
        if (binderType is ResourceContainerType.BND)
        {
            if (Project.ProjectType is ProjectType.DS1 or ProjectType.DS1R or ProjectType.DES or ProjectType.ACFA or ProjectType.ACV or ProjectType.ACVD)
            {
                ...
                {
                    TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to read {Path} during model load.", LogLevel.Error, LogPriority.High, e);
                }
            }
            else
            {
        ...
        if (binderType is ResourceContainerType.BXF)
        {
            ...
            {
                TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to read {targetBhdPath} during model load.", LogLevel.Error, LogPriority.High, e);
            }
            ...
            {
                TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to read {targetBdtPath} during model load.", LogLevel.Error, LogPriority.High, e);
            }
    ...
    public void Load()
    {
        ...
        if (binderType is ResourceContainerType.BND)
        {
            if (Parent.Project.ProjectType is ProjectType.DS1 or ProjectType.DS1R or ProjectType.DES or ProjectType.ACFA or ProjectType.ACV or ProjectType.ACVD)
            {
                ...
                {
                    TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to read {Parent.Path} during model load.", LogLevel.Error, LogPriority.High, e);
                }
            }
            else
            {
    ...
    public void Save()
    {
        ...
        if (binderType is ResourceContainerType.None)
        {
            try
            {
                ...
                TaskLogs.AddLog($"[Cauldron:Model Editor] Saved {containerPath}.");
            }
            catch (Exception e)
            {
                TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to write {containerPath} during model save.", LogLevel.Error, LogPriority.High, e);
            }
        }
        ...
        if (binderType is ResourceContainerType.BXF)
        {
            ...
            {
                TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to write {targetBhdPath} during model save.", LogLevel.Error, LogPriority.High, e);
            }
            ...
            {
                TaskLogs.AddLog($"[Cauldron:Model Editor] Failed to write {targetBdtPath} during model save.", LogLevel.Error, LogPriority.High, e);
            }

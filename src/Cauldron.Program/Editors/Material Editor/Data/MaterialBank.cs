...
public class MaterialBank
{
    ...
    public MaterialBank(string name, Cauldron baseEditor, ProjectEntry project, VirtualFileSystem targetFs)
    {
...
public class MTDWrapper
{
    ...
    public MTDWrapper(Cauldron baseEditor, ProjectEntry project, FileDictionaryEntry dictEntry, VirtualFileSystem targetFS)
    {
        BaseEditor = baseEditor;
        Project = project;
        TargetFS = targetFS;
...
public class MATBINWrapper
{
    ...
    public MATBINWrapper(Cauldron baseEditor, ProjectEntry project, FileDictionaryEntry dictEntry, VirtualFileSystem targetFS)
    {
        BaseEditor = baseEditor;
        Project = project;
        TargetFS = targetFS;

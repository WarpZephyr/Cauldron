...
public class NullViewport : IViewport
{
    ...
    public NullViewport(Cauldron baseEditor, MapEditorScreen mapEditor, ModelEditorScreen modelEditor, ViewportType viewportType, string id, int width, int height)
    {
        _vpid = id;

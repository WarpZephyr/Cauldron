...
public class Oodle
{
    ...
    public static IOodleCompressor GetOodleCompressor(int compressionLevel = -1)
    {
        ...
        throw new NoOodleFoundException($"Could not find a supported version of oo2core. "
            + $"Please copy oo2core_6_win64.dll, oo2core_8_win64.dll or oo2core_9_win64.dll into the Cauldron program directory");
#elif OSX
        throw new NoOodleFoundException($"Could not find a supported version of oo2core. "
            + $"Please copy liboo2coremac64.2.6.dylib, liboo2coremac64.2.8.dylib or liboo2coremac64.2.9.dylib into the Cauldron program directory");
#elif LINUX
        throw new NoOodleFoundException($"Could not find a supported version of oo2core. "
            + $"Please copy liboo2corelinux64.so.6, liboo2corelinux64.so.8 or liboo2corelinux64.so.9 into the Cauldron program directory");
#endif
    }

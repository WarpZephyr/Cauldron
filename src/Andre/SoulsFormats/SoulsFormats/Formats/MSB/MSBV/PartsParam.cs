...
namespace SoulsFormats
{
    public partial class MSBV
    {
        ...
        public abstract class Part : ParamEntry, IMsbPart
        {
            ...
            /// <summary>
            /// Unknown. CharaEventData? Required.
            /// </summary>
            ...
            public class ObjectConfig
            {
                ...
                public class ObjectConfigBlock
                {
                    ...
                    internal ObjectConfigBlock(BinaryReaderEx br)
                    {
                        ...
                        Unk02 = br.ReadSByte();
                        Unk03 = br.ReadSByte();
                        br.AssertInt32(8); // Offset? Seen as 32 in ACFA where the struct is 24 bytes larger.
                        Unk08 = br.ReadInt32();
                    }
                    ...
                    internal void Write(BinaryWriterEx bw)
                    {
                        ...
                        bw.WriteSByte(Unk02);
                        bw.WriteSByte(Unk03);
                        bw.WriteInt32(8); // Offset? Seen as 32 in ACFA where the struct is 24 bytes larger.
                        bw.WriteInt32(Unk08);
                    }
                }
            }
